...
public final class Addresses {
    ...
    public static final int LEFT_PHALANGE_MOTOR = 5;
    public static final int RIGHT_PHALANGE_MOTOR = 6;
    ...
    public static final int HOOK_A_SOLENOID_CHANNEL = 12;
    public static final int HOOK_B_SOLENOID_CHANNEL = 13;
    public static final int LOCKS_SOLENOID_CHANNEL = 14;
    
    	//Intake
    
    public static final int ARM_SOLENOID_CHANNEL = 10;
    public static final int WRIST_SOLENOID_CHANNEL = 11;
